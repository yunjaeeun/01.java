...
public class Applicaition {
    public static void main(String[] args) {
        ...
        * */
        ...
        Computer computer2 = new Computer("I7-14700KF", 1024, 32, "Window");
        System.out.println(computer2);

        Computer computer3 = new Computer("s-01234","구글", "픽셀",1000000, new java.util.Date(),"I7-14700KF", 1024, 32, "Window" );
