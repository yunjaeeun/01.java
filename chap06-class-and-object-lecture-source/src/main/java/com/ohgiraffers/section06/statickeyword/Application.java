...
public class Application {
    public static void main(String[] args) {
        ...
        * */
        ...
        System.out.println("non-staticField: " + stf1.getNonStaticCount());
        System.out.println("staticField: " + StaticFieldTest.getStaticCount());
        ...
        System.out.println("non-staticField: " + stf2.getNonStaticCount());
        System.out.println("staticField: " + StaticFieldTest.getStaticCount());
