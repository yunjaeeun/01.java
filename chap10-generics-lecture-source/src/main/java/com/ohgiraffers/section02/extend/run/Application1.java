...
//        RabbitFarm<Mammal> farm3 = new RabbitFarm<Mammal>();
        ...
        farm4.setAniaml(new Rabbit());
        farm4.getAniaml().cry();
        farm4.setAniaml(new Bunny());
        farm4.getAniaml().cry();            // 동적 바인딩에 의해 반환형인 Animal의 cry()가 아닌 Bunny의 cry()가 실행됨

        farm5.setAniaml(new Bunny());
        farm5.getAniaml().cry();

        farm6.setAniaml(new DrunkenBunny());
        farm6.getAniaml().cry();
