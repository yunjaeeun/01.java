package com.ohgiraffers.assertions.section01;
...
public class JupiterAssertionsTests {
    ...
    public void testAssertEquals() {
        ...
        int secondNum = 20;
        int expected = 30;
//        int expected = 31;        // 기대값이 결과랑 동일하지 않으면 테스트 실패
...
//        Assertions.assertEquals(expected, result, "이건 정확해야 해!");  // 테스트 실패 시 출력할 메세지 설정 가능.
//        Assertions.assertEquals(expected, result, 1);         // 오차범위 설정 가능함.
    }
    ...
    void testAssertNotEqualsWithInstances() {
        ...
        // then
//        Assertions.assertNotEquals(obj1, obj1);      // false
        Assertions.assertNotEquals(obj1, obj2);        // true
