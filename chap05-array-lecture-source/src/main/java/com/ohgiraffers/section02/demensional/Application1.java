...
public class Application1 {
    public static void main(String[] args) {
        ...
        /* 필기.
         *  다차원 배열
         *  다차원 배열은 2차원 이상의 배열을 의미한다(일반적으로는 사람의 인지 범위에 맞게 최대 3차원 정도를 고민한다.)
        * */

        int[][] iArr1;
        int[] iArr2[];                // 에러가 발생되진 않지만 추천되지 않음.
        int iArr3[][];                // 추천 X
...
//        iArr3 = new int[][];        // 컴파일 에러 발생
        ...
        /* 설명. 가변 배열은 아직 1차원 배열들이 생성되어 있지 않다.(NullPointerExecption도 발생 가능) */
        int length = 1;
