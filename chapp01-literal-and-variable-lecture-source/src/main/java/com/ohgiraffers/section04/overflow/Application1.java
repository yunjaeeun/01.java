...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 목차. 1. 오버플로우 */
        byte num1 = 126;                            // byte 자료형 양의 최대 저장 범위 값

        num1++;                                     // num1 = num1 + 1과 의미상 같다.
        System.out.println("num1 = " + num1);
        
        num1++;
        System.out.println("num1 = " + num1);       // byte에 담길 수 있는 값의 최대 범위를 벗어나 overflow가 발생.
        ...
        num2--;
        System.out.println("num2 = " + num2);      // byte에 담길 수 있는 값의 최대 범위를 벗어나 underflow가 발생.
        ...
        * */
        ...
        int thirdNum = 2147483647;                  // int의 최대값
