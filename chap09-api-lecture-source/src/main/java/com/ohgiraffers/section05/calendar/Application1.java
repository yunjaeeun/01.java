...
public class Application1 {
    public static void main(String[] args) {
        ...
        System.out.println("long 타입 시간을 활요한 Date형: " + new Date(today.getTime()));
        System.out.println("기준시간(1970년 9시 0분 0초): " + new Date(0L));

        /* 설명. 우리가 원하는 형태로 출력해보기(feat.SimpleDateFormat, long타입 활용하기) */
...
//        java.sql.Date sqlDate2 = (java.sql.Date)today;                        // 실제로는 sql.Date형이었던 날짜형을 util.Date형인 today에 담겨 있었다면 이 방법도 가능하다.
        ...
        java.util.Date utilDate = sqlDate;                                      // 다형성이 적용된다.(util.Date 클래스가 sql.Date의 부모 클래스기 때문에)
    }
}
