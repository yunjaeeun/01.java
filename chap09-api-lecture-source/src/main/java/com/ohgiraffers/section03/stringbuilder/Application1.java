...
public class Application1 {
    public static void main(String[] args) {
         ...
         *  StringBuffer: thread safe 기능이 추가적으로 동작함.
        * */
        StringBuilder sb = new StringBuilder("java");
//        StringBuilder sb2 = "java";       //StiringBuilder는 문자열을 다루지만 리터럴은 다루지 않음
        ...
        for (int i = 0; i < 9; i++) {
             ...
             *  따라서 System.identifyHashCode()메소드를 활용해 String으로 관리되는 문자열과 StringBuilder로
