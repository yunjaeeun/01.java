...
public class Application1 {
    public static void main(String[] args) {
        ...
        * */
        ...
        /* 필기.
         *  toLowerCase(): 모든 문자를 소분자로 변환
         *  toUpperCase(): 모든 문자를 대문자로 변환
         *  if(input == 'y' || input == "Y") 대신 if(input.toLowerCase() == 'y')사용 가능
        * */
        ...
        /* 필기.
         *  substring(): 문자열의 일부분을 잘라내여 새로운 문자열을 반환한다.
        * */
        String javamariaDB = "javamariaB";

        System.out.println("substring(3, 6): " + javamariaDB.substring(3,6));         // 3~5번
        System.out.println("substring(3): " + javamariaDB.substring(3));    // 3~ 끝
